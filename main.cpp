...
int tomann_hp = -100
int tomann_dmg = -2
float tomann_crit_chance = 0;
int draw_init_tomann = 1;
...
int main() {    //PvP TURN-BASED STRATEGY GAME
  ...
  else if (player2_action == "tomann") {
    player1_character = "Tomann";
    player1_hp = tomann_hp;
    player1_hpcap = tomann_hp;
    player1_dmg = tomann_dmg;
    player1_crit_chance = tomann_crit_chance;
    player1_initiative = draw_init_tomann;
  }
  else {
  ...
  if (player2_action == "assassin") {
    ...
    player2_character = "Tomann";
    player2_hp = tomann_hp;
    player2_hpcap = tomann_hp;
    player2_dmg = tomann_dmg;
    player2_crit_chance = tomann_crit_chance;
    player2_initiative = draw_init_tomann;
  }
  else {
